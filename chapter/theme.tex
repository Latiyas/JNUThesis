...
\setCJKfamilyfont{song}{SourceHanSerif-Regular.ttf}[AutoFakeSlant,AutoFakeBold={2}]     %% 宋体
\newcommand{\song}{\CJKfamily{song}}                                                    %% 宋体
\setCJKfamilyfont{hei}{SourceHanSans-Regular.otf}[AutoFakeSlant,AutoFakeBold={2}]       %% 黑体
\newcommand{\hei}{\CJKfamily{hei}}                                                      %% 黑体
\setCJKfamilyfont{kai}{AlibabaPuHuiTi-Regular.ttf}[AutoFakeSlant,AutoFakeBold={2}]      %% 楷体
\newcommand{\kai}{\CJKfamily{kai}}                                                      %% 楷体
\setCJKfamilyfont{li}{MaShanZheng-Regular.ttf}[AutoFakeSlant,AutoFakeBold={2}]          %% 隶书
\newcommand{\li}{\CJKfamily{li}}                                                        %% 隶书
% %% 如需加载其他中文字体，可以从网上或者C:\Windows\Fonts复制字体文件到根目录下加载即可。
% \newcommand{\fs}{\CJKfamily{fs}}        %% 仿宋
% \newcommand{\you}{\CJKfamily{you}}      %% 幼圆
\setCJKmainfont{SourceHanSerif-Regular.ttf}[AutoFakeSlant,AutoFakeBold={2}]
\setCJKsansfont{SourceHanSerif-Regular.ttf}[AutoFakeSlant,AutoFakeBold={2}]
%% 设置英文字体
