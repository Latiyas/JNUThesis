...
% \setCJKmonofont{simsun.ttc}[AutoFakeSlant,AutoFakeBold={2}]

\setCJKfamilyfont{song}{SourceHanSerif-Regular.ttf}[Path=fonts/,AutoFakeSlant,AutoFakeBold={2}]     %% 宋体
\newcommand{\song}{\CJKfamily{song}}                                                    %% 宋体
\setCJKfamilyfont{hei}{SourceHanSans-Regular.otf}[Path=fonts/,AutoFakeSlant,AutoFakeBold={2}]       %% 黑体
\newcommand{\hei}{\CJKfamily{hei}}                                                      %% 黑体
\setCJKfamilyfont{kai}{AlibabaPuHuiTi-Regular.ttf}[Path=fonts/,AutoFakeSlant,AutoFakeBold={2}]      %% 楷体
\newcommand{\kai}{\CJKfamily{kai}}                                                      %% 楷体
\setCJKfamilyfont{li}{MaShanZheng-Regular.ttf}[Path=fonts/,AutoFakeSlant,AutoFakeBold={2}]          %% 隶书
\newcommand{\li}{\CJKfamily{li}}                                                        %% 隶书
% %% 如需加载其他中文字体，可以从网上或者C:\Windows\Fonts复制字体文件到根目录下加载即可。
% \newcommand{\fs}{\CJKfamily{fs}}        %% 仿宋
% \newcommand{\you}{\CJKfamily{you}}      %% 幼圆
\setCJKmainfont{SourceHanSerif-Regular.ttf}[Path=fonts/,AutoFakeSlant,AutoFakeBold={2}]
\setCJKsansfont{SourceHanSerif-Regular.ttf}[Path=fonts/,AutoFakeSlant,AutoFakeBold={2}]
\setCJKmonofont{SourceHanSerif-Regular.ttf}[Path=fonts/,AutoFakeSlant,AutoFakeBold={2}]
%% 设置英文字体
\usepackage{unicode-math}
\setmathfont{STIX Two Math} % 设置数学字体为Times New Roman
\setmainfont{Times New Roman}
\setsansfont{Arial}
\setmonofont{Times New Roman}
% %% 数学字体替代方案
% \usepackage{mathptmx}  % 设置数学字体为Times New Roman
...
%% 设置公式上下间距
\setlength{\abovedisplayskip}{0pt}      % 控制正文到公式的上间距
\setlength{\belowdisplayskip}{0pt}      % 控制正文到公式的下间距
% \setlength{\abovedisplayshortskip}{0pt} % 控制公式之间的上间距
% \setlength{\belowdisplayshortskip}{0pt} % 控制公式之间的下间距
