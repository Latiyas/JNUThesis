...
%%-------------------这里定义论文相关信息--------------------
%% 作者名字
\newcommand{\authorName}{学生姓名（若是同等学力人员请注明“同等学力申请”，若是港澳台侨及海外留学生请注明申请人生源地）}
%% 论文题目
...
%% 论文提交时间
\newcommand{\commitDate}{2025\ 年\ 6\ 月}
%% 论文答辩时间
\newcommand{\replyDate}{2025\ 年\ 6\ 月}
%% 答辩委员会主席
\newcommand{\programCoChairs}{委员会主席\ 职称}
%% 论文评阅人
\newcommand{\Reviewer}{评阅人名字\ 职称}
%% 学位论文授予单位日期
\newcommand{\grantDate}{2025\ 年\ 6\ 月}
...
\begin{titlepage}
\begin{flushleft}
    \zihao{-1}\li\textbf{\pageHeaderTitle}
\end{flushleft}
\begin{flushleft}
\vspace{25pt}
\xiaosan{
...
论文评阅人：\Reviewer \\[25pt]
学位授予单位和日期：\schoolName \quad \grantDate \\[25pt]
}
\end{flushleft}
\end{titlepage}
\thispagestyle{empty}
